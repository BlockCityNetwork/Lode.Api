...
public class BaseHttpServer extends NanoHTTPD {
    ...
    public BaseHttpServer() {
        super(Lode.instance.getConfig().getConfigurationSection("Server").getInt("HttpPort"));
    ...
    private String GetAuthentication(String url) {
        ConfigurationSection conf = Lode.instance.getConfig().getConfigurationSection("Server").getConfigurationSection("Authentication");
